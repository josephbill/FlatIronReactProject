...
export default class EditItem extends Component{
    ...
    onSubmit(e){
        ...
        //sending http request  // updating data to mongoDatabase
        axios.post('http://localhost:5000/items/update/' + this.props.match.params.id, exercise)
